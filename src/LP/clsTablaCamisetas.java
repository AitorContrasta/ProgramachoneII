...
public class clsTablaCamisetas extends AbstractTableModel{


	private static final long serialVersionUID = 1L;
	
	private String[] columnNames = {"ID","Marca","Talla","Color", "Precio"};
    Object[][] data;
    
    public clsTablaCamisetas(ArrayList<itfProperty>miListaCamisetas)
    {
